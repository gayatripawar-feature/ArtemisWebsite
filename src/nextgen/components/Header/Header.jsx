...
//                       onClick={() =>
//                         handleNavClick(
//                           `expertise/industries/${slugify(item.label)}`,
//                         )
//                       }
//                       style={{ "--brand-color": brandColor }}
//                     >
...
//                 <Link
//                   to=""
//                   className={`${styles.navLink} ${location.pathname === "/nextgen" || location.pathname === "/nextgen/" ? styles.active : ""}`}
//                   onClick={() => setIsMenuOpen(false)}
//                 >
...
//                 <Link
//                   to="contact"
//                   className={`${styles.navLink} ${location.pathname === "/nextgen/contact" ? styles.active : ""}`}
//                   onClick={() => setIsMenuOpen(false)}
//                 >
...
//                 <Link
//                   to="about"
//                   className={`${styles.navLink} ${location.pathname === "/nextgen/about" ? styles.active : ""}`}
//                   onClick={() => setIsMenuOpen(false)}
//                 >
...
//                     <Link
//                       to=""
//                       className={`${styles.mobileNavLink} ${location.pathname === "/nextgen" || location.pathname === "/nextgen/" ? styles.active : ""}`}
//                       onClick={closeAll}
//                     >
//                       Home
//                     </Link>
...
//                     <Link
//                       to="contact"
//                       className={`${styles.mobileNavLink} ${location.pathname === "/nextgen/contact" ? styles.active : ""}`}
//                       onClick={closeAll}
//                     >
//                       Contact Us
//                     </Link>
...
//                     <Link
//                       to="careers"
//                       className={`${styles.mobileNavLink} ${location.pathname === "/nextgen/careers" ? styles.active : ""}`}
//                       onClick={closeAll}
//                     >
//                       Careers
//                     </Link>
...
//                     <Link
//                       to="about"
//                       className={`${styles.mobileNavLink} ${location.pathname === "/nextgen/about" ? styles.active : ""}`}
//                       onClick={closeAll}
//                     >
//                       About Us
//                     </Link>
...
const Header = () => {
  ...
  const renderExpertiseMegaMenu = () => (
    ...
    >
      <span
        className={`${styles.navButton} ${openDropdown === "expertise" ? styles.active : ""} ${
          isPathStarting(location.pathname, "/nextgen/expertise") ? styles.active : ""
        }`}
        aria-haspopup="menu"
        aria-expanded={openDropdown === "expertise"}
      >
  ...
  const renderNavDropdown = (key, label, content, isWide) => (
    ...
    >
      <span
        className={`${styles.navButton} ${openDropdown === key ? styles.active : ""} ${
          isPathStarting(location.pathname, `/nextgen/${key}`) ? styles.active : ""
        }`}
        aria-haspopup="menu"
        aria-expanded={openDropdown === key}
      >
