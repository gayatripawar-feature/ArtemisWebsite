    ...
    return (
      ...
      <div className={styles.applyPage} ref={successRef}>
        <div className={styles.successContainer}>
          ...
          <button className={styles.btnPrimary} onClick={() => navigate('/nextgen/careers')}>Back to Careers</button>
        </div>
      </div>
    );
  }
    ...
    <div className={styles.applyPage}>
      ...
      <section className={styles.jobHero}>
        <div className={styles.heroInner}>
          <button className={styles.backLink} onClick={() => navigate('/nextgen/careers')}>
