...
const BannerSlider = () => {
  ...
  const handleCTAClick = (label) => {
    let sectionId = '';
    if (label === 'View Ongoing') {
      sectionId = 'ongoing-section';
    } else if (label === 'View Projects') {
      sectionId = 'upcoming-section';
    }

    // Navigate to projects page and scroll to section
    navigate('../projects');
    // Use setTimeout to ensure the page is rendered before scrolling
    setTimeout(() => {
    ...
    >
      ...
      <div className={styles.bannerContent} key={currentIndex}>
        ...
        <div className={styles.ctaRow}>
          <button className={styles.bannerExploreBtn} onClick={() => handleCTAClick(slide.ctaLabel)}>
            {slide.ctaLabel}
